...
func dialTimeout(f newClientFunc, network string, address string, opts ...*option.Option) (*Client, error) {
...
// 使用 http@10.0.0.1:7001, tcp@10.0.0.1:9999 类型用于区分协议
